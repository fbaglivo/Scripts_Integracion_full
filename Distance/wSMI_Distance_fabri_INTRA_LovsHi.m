...
%% Retention Ret Low vs Hi

Pret=cat(3,P12_ret_lofreq.WSMI_cond2TRIAL,P12_ret_lofreq.WSMI_cond1TRIAL);
Ppostret=cat(3,P12_ret_hifreq.WSMI_cond2TRIAL,P12_ret_hifreq.WSMI_cond1TRIAL);
...
title('Low vs High Frequency Distance Retention')
xlabel('Distance')
ylabel('wSMI')
saveas(gcf,'P12 Low vs High Frequency Distance Retention','jpg')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% PostRetention Low vs High

Pret=cat(3,P12_postret_lofreq.WSMI_cond2TRIAL,P12_postret_lofreq.WSMI_cond1TRIAL);
...
figure(1)
plot(t,vect_dist,color{1});
title('Low vs High Frequency Distance Post')
xlabel('Distance')
ylabel('wSMI')
saveas(gcf,'P12 Low vs High Frequency Distance Post','jpg')
