...
P12_ret_lofreq=load('D:\_INECO\Procesamiento\iEEG_Toolbox\Produccion\Scripts_pre-analisis\Integracion\Paciente12\MI\P12_PostRetention_51000');
...
Ptemp=P12_ret_lofreq.WSMI_cond2;
Ptemp(P12_ret_lofreq.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
...
Ptemp=P12_ret_lofreq.WSMI_cond1;
Ptemp(P12_ret_lofreq.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P12)));
...
xlabel('Distance')
ylabel('wSMI')
saveas(gcf,'Figs/12Low Frequency Distance Retention Feat versus Bind ','jpg')
...
Ptemp=P12_ret_lofreq_obj.WSMI_cond2;
Ptemp(P12_ret_lofreq_obj.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P12)));
...
Ptemp=P12_ret_lofreq_obj.WSMI_cond1;
Ptemp(P12_ret_lofreq_obj.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P12)));
...
title('Low Frequency Distance Retention Objects Feat versus Bind')
xlabel('Distance')
ylabel('wSMI')
saveas(gcf,'Figs/12Low Frequency Distance Retention Objects Feat versus Bind ','jpg')
...
Ptemp=P12_ret_hifreq.WSMI_cond2;
Ptemp(P12_ret_hifreq.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P12)));
...
Ptemp=P12_ret_hifreq.WSMI_cond1;
Ptemp(P12_ret_hifreq.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P12)));
...
xlabel('Distance')
ylabel('wSMI')
saveas(gcf,'Figs/12High Frequency Distance Retention Feat versus Bind ','jpg')
...
Ptemp=P12_ret_hifreq_obj.WSMI_cond2;
Ptemp(P12_ret_hifreq_obj.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P12)));
...
Ptemp=P12_ret_hifreq_obj.WSMI_cond1;
Ptemp(P12_ret_hifreq_obj.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P12)));
...
title('High Frequency Distance Retention Objects Feat versus Bind')
xlabel('Distance')
ylabel('wSMI')
saveas(gcf,'Figs/12High Frequency Distance Retention Objects Feat versus Bind ','jpg')
