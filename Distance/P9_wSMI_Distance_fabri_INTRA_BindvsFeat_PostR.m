...
Ptemp=P9_postret_lofreq.WSMI_cond2;
Ptemp(P9_postret_lofreq.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
...
Ptemp=P9_postret_lofreq.WSMI_cond1;
Ptemp(P9_postret_lofreq.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P9)));
...
Ptemp=P9_postret_lofreq_obj.WSMI_cond2;
Ptemp(P9_postret_lofreq_obj.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P9)));
...
Ptemp=P9_postret_lofreq_obj.WSMI_cond1;
Ptemp(P9_postret_lofreq_obj.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P9)));
...
xlabel('Distance')
ylabel('wSMI')
saveas(gcf,'Figs/9Low Frequency Distance PostRetention Objects Feat versus Bind ','jpg')
...
Ptemp=P9_postret_hifreq.WSMI_cond2;
Ptemp(P9_postret_hifreq.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P9)));
...
Ptemp=P9_postret_hifreq.WSMI_cond1;
Ptemp(P9_postret_hifreq.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P9)));
...
Ptemp=P9_postret_hifreq_obj.WSMI_cond2;
Ptemp(P9_postret_hifreq_obj.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P9)));
...
Ptemp=P9_postret_hifreq_obj.WSMI_cond1;
Ptemp(P9_postret_hifreq_obj.Ps>0.001)=0;
Ptemp(Ptemp<0)=0;
Smean=triu(Ptemp);
max_d=ceil(max(max(C_P9)));
...
xlabel('Distance')
ylabel('wSMI')
saveas(gcf,'Figs/9High Frequency Distance PostRetention Objects Feat versus Bind ','jpg')
