...
Pret=cat(3,P12_ret_lofreq.WSMI_cond2TRIAL,P12_ret_lofreq.WSMI_cond1TRIAL);
Ppostret=cat(3,P12_postret_lofreq.WSMI_cond2TRIAL,P12_postret_lofreq.WSMI_cond1TRIAL);
...
[t df pvals] = statcond(DATA,'mode','bootstrap','paired','on','naccu', 700);
...
for j=1:size(Pret,3)
    ...
    Pretonetrial(find(Ps>0.01))=0;
    Ppostretonetrial(find(Ps>0.01))=0;
...
xlabel('Distance')
ylabel('wSMI')
saveas(gcf,'P12 Low Frequency Distance Retention diff Feat versus Bind','jpg')
...
Pret=cat(3,P12_ret_hifreq.WSMI_cond2TRIAL,P12_ret_hifreq.WSMI_cond1TRIAL);
Ppostret=cat(3,P12_postret_hifreq.WSMI_cond2TRIAL,P12_postret_hifreq.WSMI_cond1TRIAL);
...
xlabel('Distance')
ylabel('wSMI')
saveas(gcf,'P12 High Frequency Distance diff Retention Feat versus Bind','jpg')
