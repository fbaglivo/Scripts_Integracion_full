...
path_mat=('D:\_INECO\Procesamiento\iEEG_Toolbox\Produccion\Scripts_pre-analisis\Integracion\Paciente9\MI\SMI_P9\')
...
[t df pvals] = statcond(DATA,'mode','boostrap','paired','on','naccu', 500);
...
save(['P9_' fname '_' num2str(ntau) '.mat' ],'WSMI_cond1','WSMI_cond2','WSMI_cond1TRIAL','WSMI_cond2TRIAL','T','Ps');