...
% Auto-generated by MATLAB on 30-Apr-2015 15:16:57

% Set up figure to receive data sets and fits
f_ = clf;
figure(f_);
set(f_,'Units','Pixels','Position',[473 113 688 479]);
...
if all(isfinite(xlim_))
    ...
    set(ax_, 'XLim',[-29.709402427673339, 122.33909069061279]);
end
...
% data.
%    cv_ = { 1.5675383183476719, 11.146725145634392};
%    cf_ = cfit(ft_,cv_{:});
