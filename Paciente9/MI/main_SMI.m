...
%%
addpath('F:\_INECO\Procesamiento\Toolbox\minieeglab\')

path_mat=('F:\_INECO\Procesamiento\iEEG_Toolbox\Produccion\Scripts_pre-analisis\Integracion\Paciente9\MI\SMI_P9\')
fname='PostRetention_Objects'
...
for i = 1:90
    for j = (i+1):90
        ...
        n = n + 1;
        WSMI_cond1(i,j) = wSMI_cond1mean(n);
        WSMI_cond1(j,i) = wSMI_cond1mean(n);
        WSMI_cond2(i,j) = wSMI_cond2mean(n);
        WSMI_cond2(j,i) = wSMI_cond2mean(n);
...
% 
% [H,P,CI,STATS] = ttest2(wSMI_cond1',wSMI_cond2'); % rojo / azul  
...
save(['P9_' fname '_' num2str(ntau) '1000.mat' ],'WSMI_cond1','WSMI_cond2','WSMI_cond1TRIAL','WSMI_cond2TRIAL','T','Ps');