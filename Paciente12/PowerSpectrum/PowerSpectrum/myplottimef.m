function g = myplottimef(titleName,P, R, Pboot, Rboot, ERP, freqs, times, mbase, maskersp, maskitc, g);
%
% compute ERP
%

display ('INNNNN plottimef')
...
hold off;
% 
saveas(gcf, ['Figs/' titleName '_ERPS'],'png')
saveas(gcf, ['Figs/' titleName '_ERPS'],'fig')